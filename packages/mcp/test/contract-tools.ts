...
export const CONTRACT_TOOLS = [
  ...
  "send",
  "whoami",
  // Work Core の口(PBI-0400 / CAP-3 V9・図79)。checkpoint(V3) / transfer_primary(V5) / fork /
  // start_review(V8)は裏がまだ無いので **口も無い**(死んだ path を置かない)。claim は
  // held な work を上書きできず権限段自体が要らないので、こちらも口を足していない
  "work_assigned",
  "work_capsule",
  "work_capsules",
  "work_context_put",
